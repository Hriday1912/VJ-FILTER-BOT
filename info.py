...
BOT_TOKEN = environ.get('BOT_TOKEN', 7792844100:AAF4Eo3973UcbylNXAYYZ00zWwvOJkdQ35U"")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', https://t.me/Superviewerstar'').split()] # For Multiple Id Use One Space Between Each.
