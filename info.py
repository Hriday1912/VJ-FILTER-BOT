...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002254441842 6131046629').split()]  # For Multiple Id Use One Space Between Each.
